...
with open("/Users/alka/Devel/LiteGrave/data/preprocessed_pdf/27117806.pkl", "rb") as f:
...
paper_summary_df = paper_summary_df.query(f"page <= {min_page_id + 1}")
...
logger.info(
    f"""Number of rows in first two pages excluding {exclude_list}:
